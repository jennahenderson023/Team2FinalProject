...
<form action="http://localhost:8888/FINAL%20PROJECT/createathletes.php">
      ...
      <form action="http://localhost:8888/FINAL%20PROJECT/readscholarship.php">
       ...
       <form action="http://localhost:8888/FINAL%20PROJECT/joinathletescholarship.php">
        <button>VIEW ATHLETE SCHOLARSHIPS JOIN TABLE</button>
      </form>
...
echo <<<_END
	<pre>
	AthleteID: <a href='updateathlete.php?AthleteID=$row[AthleteID]'>$row[AthleteID]</a>
	TeamID: $row[TeamID]
